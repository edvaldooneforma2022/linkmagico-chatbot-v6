...
# ai_engine = AIConversationEngine(db) # Removido daqui
...
def chat():
    ...
    try:
        # Inicializa ai_engine aqui para garantir que db esteja no contexto do app
        ai_engine = AIConversationEngine(db)
